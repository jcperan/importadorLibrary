...
public class Plagas implements Serializable {
	...
	@OneToMany(mappedBy = "plagaBean")
	private Set<Controlesplagas> controles;

	public Set<Controlesplagas> getControles() {
		return controles;
	}

	public void setControles(Set<Controlesplagas> controles) {
	...
	public String toString() {
		return "com.acisa.cultivos.modelos.Plagas[ codigo=" + codigo + " ]";
	}
